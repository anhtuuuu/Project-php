...
<body>
    <form action="<?php echo $level ?>EditDataBase/edit/E_add_table_client.php" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control" placeholder="Enter Password" name="password" id="position">
        </div>
        <div class="form-group">
            <label for="age">Age:</label>
            <input type="email" class="form-control" placeholder="Enter Email" name="email" id="age">
        </div>
        <div class="form-group">
