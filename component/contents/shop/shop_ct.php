            ...
            <div class="sidebar_widget special">
                ...
                <div class="special_product_inner mb-20">
                    <div class="special_p_thumb">
                        <a href="single-product.php"><img src="<?php echo $level?><?php echo $level?>assets\img\cart\cart3.jpg" alt=""></a>
                    </div>
                ...
                <div class="special_product_inner">
                    <div class="special_p_thumb">
                        <a href="single-product.php"><img src="<?php echo $level?><?php echo $level?>assets\img\cart\cart18.jpg"
                                alt=""></a>
                    </div>
                    <div class="small_p_desc">
                        <div class="product_ratting">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="single_product">
                                    ...
                                    <div class="product_content">
                                        ...
                                        <h3 class="product_title"><a href="single-product.php">Curabitur sodales</a>
                                        </h3>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="single_product">
                                    ...
                                    <div class="product_content">
                                        ...
                                        <h3 class="product_title"><a href="single-product.php">Quisque ornare dui</a>
                                        </h3>
                                    </div>
                                    <div class="product_info">
                                        <ul>
